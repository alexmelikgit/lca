      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <motion.div
            ...
            custom={0.44}
            variants={fadeUp}
            style={{ display: 'flex', borderTop: '1px solid rgba(139,37,53,0.12)', paddingTop: '24px' }}
          >
            {content.stats.map((stat, i) => (
              <div
                ...
                style={{
                  ...
                  borderLeft: i > 0 ? '1px solid rgba(139,37,53,0.12)' : 'none',
                }}
              >
                <span style={{
                  display: 'block',
        ...
        >
          ...
          >
            ...
            {/* Vignette */}
            <defs>
              <radialGradient id="diasporaHeroVg" cx="50%" cy="50%" r="75%">
                <stop offset="30%" stopColor="transparent" />
                <stop offset="100%" stopColor="#E8F0E0" stopOpacity="0.55" />
              </radialGradient>
            </defs>
            <rect width="500" height="420" fill="url(#diasporaHeroVg)" />
            {/* Horizon line */}
            ...
            <div style={{
              ...
              <div style={{ background: '#2D5A27', padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  ...
                  <div style={{ color: 'white', fontSize: '14px', fontWeight: 600 }}>Plot 12 — Armavir</div>
                </div>
              ...
              {/* Harvest option — diaspora-specific */}
              <div style={{ padding: '14px 20px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ width: '34px', height: '34px', background: '#F9EDF0', borderRadius: '9px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '17px', flexShrink: 0 }}>🎁</div>
                <div>
                  <div style={{ color: '#9B9B82', fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Harvest option</div>
                  <div style={{ color: '#1A1A14', fontSize: '12px', fontWeight: 500 }}>Donate · Family in Gyumri</div>
                </div>
              </div>
            </div>
          </div>
